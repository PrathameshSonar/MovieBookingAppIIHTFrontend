...
const UpdateMovie = () => {
  ...
  const [movie, setMovie] = useState({
    movieName: movieName,
    theaters: [{ theaterName: "", availableSeat: "", ticketStatus: "" }],
  });
  ...
  const handleAddTheater = () => {
    setMovie({
      ...
      theaters: [
        ...movie.theaters,
        { theaterName: "", availableSeat: "", ticketStatus: "" },
      ],
    });
  };
            ...
            {movie.theaters.map((theater, index) => (
              <div key={index} className="mb-4 border-4 rounded">
                ...
                <div>
                  ...
                  {theater.ticketStatus && (
                    <p>You selected: {theater.ticketStatus}</p>
                  )}
                </div>
                {index > 0 && (
                  <button
